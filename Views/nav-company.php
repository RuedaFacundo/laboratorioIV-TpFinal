    ...
    <ul class="navbar-nav ml-auto">
        ...
        <a class="nav-link dropdown-toggle" data-bs-toggle="dropdown" href="" role="button" aria-expanded="false">Ofertas Laborales</a>
            <ul class="dropdown-menu">
                <li><a class="dropdown-item" href="<?php echo FRONT_ROOT ?>JobOffer/ShowAddViewCompany">Agregar</a></li>
                <li><a class="dropdown-item" href="<?php echo FRONT_ROOT ?>JobOffer/ShowListOffersByCompany">Listar</a></li>
            </ul>
        </li>
        <li class="nav-item">
